...
import dimensional.common.Tokenizer
import dimensional.common.tokenize
import dimensional.oss.keiren.common.Badge
import dimensional.oss.keiren.chat.ext.decodeIrc
 ...
 */
public class IrcMessageParser(message: String) : Tokenizer<IrcMessagePart>(message) {
    public companion object {
        public fun parse(message: String): List<IrcMessagePart> {
